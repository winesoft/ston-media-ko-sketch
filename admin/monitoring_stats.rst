...
채널 통계는 고정된 것이 아니라 동적으로 생성/파괴된다. ( :ref:`multi-protocol-live-channel` 참고)
채널이 생성됨과 동시에 통계는 제공되지만, 통계가 삭제되는 시점은 API에 따라 약간 다르다.

===================== ================================
API                   통계 삭제시점
===================== ================================
/monitoring/realtime  채널 파괴시점
/monitoring/average   채널이 파괴되고 average통계가 제공된 시점
===================== ================================
...
.. note::
   ...
   채널 통계를 고정시키고 싶다면 가상호스트 당 하나의 채널만 서비스하는 것이 바람직하다.
